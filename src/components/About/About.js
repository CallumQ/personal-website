                    ...
                    <Grid centered columns={16}>
                        <Grid.Row>
                            ...
                            <Grid.Column width={13}>
                                ...
                                <p>I'm originally from just outside of Edinburgh but I'm currently working in Manchester as a software engineer. I attended Heriot-Watt University where I studied Computer Systems, and graduated with a 1<sup>st</sup> Class Honours Degree in June, 2017. When it comes to programming, there is no one kind of project that I enjoy or seek out. I enjoy seeing complicated problems being solved in smart but straightforward approaches (sometimes thats not possible, though).</p>
                                ...
                                <p>I've also got a <a target="_blank" href="https://medium.com/@callumrussellquigley">blog <Icon name='external'/></a> where I post about some problems that I've been solving, or just a quick guide for other developers who might be a bit stuck.</p>
